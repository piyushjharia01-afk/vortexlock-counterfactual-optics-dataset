...
Canonical Source URL after publication: `https://github.com/anjalikhatri019-hub/vortexlock-counterfactual-optics-dataset/releases/tag/v1.3.0`
...
2. Create tag `v1.3.0` from the default branch.
3. Set release title to `VORTEXLOCK Blind Optical Dual-Witness Corpus v1.3.0`.
